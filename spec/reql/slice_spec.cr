...
describe ReQL do
  it "can take a slice of an array" do
    r([0, 1, 2, 3, 4]).slice(1, 3).run.value.should eq [1, 2, 3]
  ...
  it "can count a slice of an array" do
    r([0, 1, 2, 3, 4]).slice(1, 3).count.run.value.should eq 3
  ...
  it "can take a slice of a stream" do
    r.range(5).slice(1, 3).run.value.should eq [1, 2, 3]
  ...
  it "can count a slice of a stream" do
    r.range(5).slice(1, 3).count.run.value.should eq 3
