...
describe ReQL::Datum do
  arr = [
    ...
    Bytes[1, 2, 3],
    Time.unix(0),
    Time.local(2016, 2, 15, location: Time::Location.load("Europe/Berlin")),
    Time.utc(2016, 2, 15),
    Time.local(2016, 2, 15, 10, 20, 30, location: Time::Location.load("Europe/Berlin")),
    Time.local(2019, 7, 12, location: Time::Location.load("America/Bahia")),
    Time.utc,
    Time.local(2098, 7, 12, location: Time::Location.load("America/Bahia")),
    "",
    "a",
    "aa",
    "aaa",
